...
int main () {
    ...
    Molecule H2("Inputs/H2.txt");

    // Matrices and Energy of H2
    mat overlap_mat_H2 = calcOverlapMatrix(H2);
    mat hamiltonian_mat_H2 = calcHamiltonianMatrix(H2, overlap_mat_H2);
    ...
    Molecule C2H2("Inputs/C2H2.txt");
    Molecule C2H4("Inputs/C2H4.txt");
    Molecule H2_2("Inputs/H2.txt");
